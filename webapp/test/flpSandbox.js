		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#oupotcpricingupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"oupotcpricingupload-display": {
								"semanticObject": "oupotcpricingupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=oup.otc.pricingupload",
									"url": sap.ui.require.toUrl("oup/otc/pricingupload")
								}
							}
						}
					}
